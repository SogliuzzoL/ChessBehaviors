...
of the un-tuned Maia-2 architecture combined with nucleus pruning and descent search optimization.
"""
...
def evaluate_maia2_nucleus_descent_baseline(
    ...
    and descent search optimization across human subject cohorts.
    ...
    output_predictions_path = (
        f"data/maia2_nucleus_descent_{max_iterations}_predictions.csv"
    )
    output_accuracies_path = (
        f"data/maia2_nucleus_descent_{max_iterations}_accuracies.csv"
    )
...
if __name__ == "__main__":
    evaluate_maia2_nucleus_descent_baseline()
