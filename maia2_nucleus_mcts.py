...
if __name__ == "__main__":
    ...
    predictions_df.to_csv(f"data/maia2_nucleus_mcts_{N}_predictions.csv", index=False)

    accuracies_df = pl.DataFrame(accuracies)
    accuracies_df.write_csv(f"data/maia2_nucleus_mcts_{N}_accuracies.csv")
    accuracies_df.write_csv("data/maia2_nucleus_mcts_accuracies.csv")
